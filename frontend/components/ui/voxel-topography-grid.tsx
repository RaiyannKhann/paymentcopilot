...
export interface VoxelTopographyGridProps {
  ...
  wireColor?: string;
  speed?: number;
  /** Canvas clear color, drawn behind every voxel each frame. */
  backgroundColor?: string;
  /**
   * Renders as a bare canvas that fills its positioned parent instead of the
   * demo's centered card frame — for dropping in as a page/section background.
   */
  fill?: boolean;
}
